...
- Improved Cargo workspace dependency hovers, completions, and diagnostics
...
- Added release binaries for arm-based Windows & Linux

### Fixed

- Fixed regression causing GitHub PATs to be ignored even if configured
